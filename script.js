...
// первый вариант (мне показался офигительной идеей чтобы сразу менялся цвет при вводе текста(подхватил идею из видео-урока когда тект сразу в спане меняли, просто жуть как классно DDD))
